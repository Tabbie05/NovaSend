  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="page-enter flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">WhatsApp Inbox</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">Generate, edit and send WhatsApp campaigns.</p>
        </div>
      </div>
