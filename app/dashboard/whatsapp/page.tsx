    ...
    <div className="mx-auto max-w-6xl space-y-8">
      <div className="page-enter flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300">Generate, edit and send WhatsApp campaigns.</p>
        </div>
      </div>

      <div className="grid gap-6 xl:grid-cols-[1fr_360px]">
        <Card className="border-white/70 bg-white/90 shadow-[0_20px_60px_rgba(15,23,42,0.08)] hover:translate-y-0 hover:shadow-[0_28px_70px_rgba(15,23,42,0.12)] dark:border-slate-700 dark:bg-slate-900/80">
